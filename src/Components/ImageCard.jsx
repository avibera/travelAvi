...
const ImageCard = ({ item }) => {
  ...
  return (
    <Link to={`${item.slug}/package`} state={{ data }}>
      <div className="relative group font-knit">
        <div>
        ...
        <div className="absolute bottom-10 left-4">
          ...
          <div className="text-white text-lg sm:text-2xl font-bold flex mt-2">
            <IndianRupee className="w-4 h-5 sm:w-8 sm:h-7 mt-1" />
            5000
          </div>
        </div>
      </div>
